...
const Contact = () => {
    return (
        <>
            <BreadCrumb text='Contact Us' img="https://www.frstraining.com/media/1238/frs-training-healthcare-support-major.jpg?anchor=center&mode=crop&width=850&height=478&quality=75"></BreadCrumb>
            <div className='container'>
                ...
                <div class="row row-cols-1 row-cols-md-2 g-4 py-5">
                    <form class="row g-3 shadow p-lg-5">
                        ...
                        <div class="col-12">
                            <button type="submit" class="contact-btn w-100">Submit</button>
                        </div>
                    </form>
